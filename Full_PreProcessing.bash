...
if [ -f ${output_folder}/anat/${FULLID_folder}/atlas/${FULLID_file}_BNA2highres_FIRST.nii.gz ]; then
  ...
  bash ${scriptfolder}/steps/fs_to_anat.bash ${anatomical} ${anatomical_noneck} ${anatomical_brain} ${brainmask} ${freesurfer_folder} ${FULLID_folder} ${FULLID_file} &&\
...
if [ -f ${output_folder}/func/${FULLID_folder}/${FULLID_file}_BNA_timeseries.txt ]; then
  ...
  bash ${scriptfolder}/steps/func_sdc.bash ${anatomical_brain} ${fmri} ${scriptfolder} ${FULLID_file} ${FULLID_folder} ${remove_vols} ${func_sdc_oppPE} || print_error ${output_folder} ${FULLID_folder}
  fi
...
if [ -f ${output_folder}/dwi/${FULLID_folder}/tractography/atlas/${FULLID_file}_BNA_Atlas_FA.csv ]; then
  ...
  bash ${scriptfolder}/steps/dwi_recon.bash ${input_folder} ${FULLID_file} ${FULLID_folder} ${dwi_skullreg} ${scriptfolder} &&\
