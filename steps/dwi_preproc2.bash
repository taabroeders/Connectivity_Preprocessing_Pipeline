...
#SBATCH --partition=luna-gpu-short        #using luna short queue
...
exec 3> dwi/${FULLID_folder}/preprocessing/code_trace2.txt
BASH_XTRACEFD=3
...
fslroi dwi/${FULLID_folder}/preprocessing/Synb0_DISCO/output/b0_all_topup.nii.gz \
       dwi/${FULLID_folder}/preprocessing/${FULLID_file}_init_b0_vol0.nii.gz \
       0 1 &&\

bet dwi/${FULLID_folder}/preprocessing/${FULLID_file}_init_b0_vol0.nii.gz \
    dwi/${FULLID_folder}/preprocessing/${FULLID_file}_init_b0_brain.nii.gz \
    -m -f 0.4 &&\

eddy --imain=dwi/${FULLID_folder}/preprocessing/${FULLID_file}_denoised_unringed_dwi.nii.gz \
     --mask=dwi/${FULLID_folder}/preprocessing/${FULLID_file}_init_b0_brain_mask.nii.gz \
...
dwifslpreproc dwi/${FULLID_folder}/preprocessing/${FULLID_file}_denoised_unringed_dwi.nii.gz \
              ...
              -pe_dir ${PE} \
              -readout_time ${RT} \
              -export_grad_fsl dwi/${FULLID_folder}/preprocessing/${FULLID_file}_eddy_unwarped_dwi.eddy_rotated_bvecs \
              dwi/${FULLID_folder}/preprocessing/${FULLID_file}_eddy_unwarped_dwi.eddy_rotated_bvals \
              -nocleanup \
...
#Create final mask, check this mask well!
dwi2mask -fslgrad \
         dwi/${FULLID_folder}/preprocessing/${FULLID_file}_eddy_unwarped_dwi.eddy_rotated_bvecs \
         ${dwi_bval} \
	 dwi/${FULLID_folder}/preprocessing/${FULLID_file}_eddy_unwarped_biascor_dwi.nii.gz \
    	 dwi/${FULLID_folder}/preprocessing/${FULLID_file}_final_b0_brain.nii.gz \
