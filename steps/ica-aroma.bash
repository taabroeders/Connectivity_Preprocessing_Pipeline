...
exec 3> func/${FULLID}/code_trace.txt
BASH_XTRACEFD=3
...
#Select MC file
if [ -f ${PWD}/func/${FULLID}/DisCo/output/rBOLD.par ];then
	nvol=$(fslval ${PWD}/func/${FULLID}/fmri.feat/filtered_func_data.nii.gz dim4)
	tail ${PWD}/func/${FULLID}/DisCo/output/rBOLD.par -n ${nvol} > \
	${PWD}/func/${FULLID}/DisCo/output/rBOLD_nodummy.par
	MCfile=${PWD}/func/${FULLID}/DisCo/output/rBOLD_nodummy.par
else	
...
mv func/${FULLID}/code_trace.txt func/${FULLID}/ICA_AROMA/code_trace.txt &&\
