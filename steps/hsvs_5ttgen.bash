...
exec 3> anat/${FULLID_folder}/hsvs_5tt/code_trace.txt
BASH_XTRACEFD=3
...
if [[ ${freesurfer_long_reg} != 'NA' ]];then
mri_convert -ait ${freesurfer_long_reg} \
            -rl anat/${FULLID_folder}/hsvs_5tt/${FULLID_file}_5tthsvs_anat.nii.gz \
            -rt nearest -odt uchar \
            ${lesionmask} anat/${FULLID_folder}/hsvs_5tt/${FULLID_file}_lesionmask_anat.nii.gz

5ttedit -path anat/${FULLID_folder}/hsvs_5tt/${FULLID_file}_lesionmask_anat.nii.gz \
...
#transform brainstem segmentation to anat-space
mrconvert anat/${FULLID_folder}/hsvs_5tt/all_segmentations/brain_stem.mif \
          anat/${FULLID_folder}/hsvs_5tt/all_segmentations/brain_stem.nii.gz &&\

mri_vol2vol --mov anat/${FULLID_folder}/hsvs_5tt/all_segmentations/brain_stem.nii.gz \
            --targ ${anatomical} --regheader \
            --o anat/${FULLID_folder}/hsvs_5tt/${FULLID_file}_brainstem_anat.nii.gz \
            --no-save-reg --nearest &&\
