...
exec 3> dwi/${FULLID_folder}/anat2dwi/code_trace.txt
BASH_XTRACEFD=3
...
if [ $skullreg -eq 0 ];then
antsRegistrationSyN.sh -d 3 \
                       -f anat/${FULLID_folder}/${FULLID_file}_T1w_brain.nii.gz \
                       -m dwi/${FULLID_folder}/preprocessing/${FULLID_file}_b0_brain.nii.gz \
                       -ta \
                       -o dwi/${FULLID_folder}/anat2dwi/reg/${FULLID_file}_LinTrans_dwi2anat_ || exit 1
else
antsRegistrationSyN.sh -d 3 \
                       -f anat/${FULLID_folder}/${FULLID_file}_T1w.nii.gz \
                       -m dwi/${FULLID_folder}/preprocessing/${FULLID_file}_b0_vol0.nii.gz \
                       -ta \
                       -o dwi/${FULLID_folder}/anat2dwi/reg/${FULLID_file}_LinTrans_dwi2anat_
fi
...
#                               --initial-transform dwi/${FULLID_folder}/anat2dwi/reg/${FULLID_file}_LinTrans_dwi2anat_0GenericAffine.mat \
#                               --skip-linear \
...
antsApplyTransforms -i anat/${FULLID_folder}/hsvs_5tt/${FULLID_file}_5tthsvs_anat_lesions.nii.gz \
                    ...
                    -t [dwi/${FULLID_folder}/anat2dwi/reg/${FULLID_file}_LinTrans_dwi2anat_0GenericAffine.mat,1] \
                    -d 3 -e 3 --verbose &&\
