...
exec 3> anat/${FULLID_folder}/FS_to_t1/code_trace.txt
BASH_XTRACEFD=3
...
if [ ${anatomical_brain_mask}=='NA' ];then
#freesurfer normalized brain-extracted T1
mri_vol2vol --mov ${freesurfer_folder}/mri/brain.mgz \
            --targ ${anatomical} \
            --regheader --o anat/${FULLID_folder}/FS_to_t1/${FULLID_file}_fsbrain_anat.nii.gz --no-save-reg &&\

#brain mask
fslmaths  anat/${FULLID_folder}/FS_to_t1/${FULLID_file}_fsbrain_anat.nii.gz \
          -bin anat/${FULLID_folder}/FS_to_t1/${FULLID_file}_brainmask_anat.nii.gz || exit 1

else

#brain mask
cp ${anatomical_brain_mask} anat/${FULLID_folder}/FS_to_t1/${FULLID_file}_brainmask_anat.nii.gz || exit 1

fi

#Apply brain mask to N3 corrected T1
fslmaths anat/${FULLID_folder}/FS_to_t1/${FULLID_file}_nu_anat.nii.gz \
         -mas anat/${FULLID_folder}/FS_to_t1/${FULLID_file}_brainmask_anat.nii.gz \
         anat/${FULLID_folder}/FS_to_t1/${FULLID_file}_brain_anat.nii.gz

#Remove neck from N3 corrected T1
