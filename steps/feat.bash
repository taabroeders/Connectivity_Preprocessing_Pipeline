...
if [ -f ${outputdir}/DisCo/output/BOLD_u.nii.gz ]; then 
    restingstate=${outputdir}/DisCo/output/BOLD_u.nii.gz
elif [ -f ${outputdir}/DisCo/output/${FULLID_file}_bold_DisCo.nii.gz ]; then
    restingstate=${outputdir}/DisCo/output/${FULLID_file}_bold_DisCo.nii.gz
fi
...
if [ -f ${outputdir}/DisCo/output/BOLD_u.nii.gz ] || [ -f ${outputdir}/DisCo/output/${FULLID_file}_bold_DisCo.nii.gz ];then
sed -i 's|set fmri(mc) 1|set fmri(mc) 0|' ${outputdir}/feat_settings.fsf
fi
