...
mrconvert ${FREESURFER_DIR}/mri/norm.mgz -datatype uint16 -stride +1,+2,+3 T1RAS_16b.nii -force
...
mrtransform ${FREESURFER_DIR}/mri/norm.mgz -template aparc.mif - | \
...
for vessel in *vessel.mif 5th-Ventricle.mif;do
