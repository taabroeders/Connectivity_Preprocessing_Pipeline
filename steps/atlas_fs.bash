...
exec 3> anat/${FULLID_folder}/Atlas_to_FS/code_trace.txt
BASH_XTRACEFD=3
...
mris_anatomical_stats -mgz -cortex ${freesurfer_folder}/label/lh.cortex.label -f \
                      anat/${FULLID_folder}/Atlas_to_FS/${FULLID_file}_lh.BN_Atlas.stats -b -a ${PWD}/anat/${FULLID_folder}/Atlas_to_FS/${FULLID_file}_lh.BN_Atlas.annot \
                      ${FULLID_file} lh white &&\

#quantify anatomical properties RH
mris_anatomical_stats -mgz -cortex ${freesurfer_folder}/label/rh.cortex.label -f \
                      anat/${FULLID_folder}/Atlas_to_FS/${FULLID_file}_rh.BN_Atlas.stats -b -a ${PWD}/anat/${FULLID_folder}/Atlas_to_FS/${FULLID_file}_rh.BN_Atlas.annot \
                      ${FULLID_file} rh white &&\
