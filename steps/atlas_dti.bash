...
exec 3> dwi/${FULLID_folder}/anat2dwi/atlas/code_trace.txt
BASH_XTRACEFD=3
...
fslmaths dwi/${FULLID_folder}/anat2dwi/atlas/${FULLID_file}_BNA_dwi.nii.gz \
	 -mul dwi/${FULLID_folder}/preprocessing/${FULLID_file}_final_b0_brain_mask.nii.gz \
	 dwi/${FULLID_folder}/anat2dwi/atlas/${FULLID_file}_BNA_masked_dwi.nii.gz
